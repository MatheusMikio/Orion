    ...
    return(
        <div className={styles.card}>
            <ul>
                ...
                <li><span>CPF:</span> {formatCPF(client.cpf)}</li>
                <li><span>Email:</span> {client.email}</li>
                <li><span>Idade:</span> {client.idade}</li>
                <li><span>Valor Total:</span> {client.dividas.reduce((total, divida) => total + divida.valor, 0).toLocaleString('pt-BR',{ style: 'currency', currency: 'BRL'})}</li>
            </ul>
            <div>
